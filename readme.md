...
When using external dependencies (libraries installed with PIP), it is best to use a python vitrtual environment (venv) to create isolated environments and avoid conflics between projects.
...
- When using Pip you don't want to create version conflicts to your system - so you install dependencies at the project level.
...
- You shold gitignore your `venv` folder, but you want to keep track of what needs installed for your program (whatever you pip installed)
...
- If you pull your project down from github or other source control, you will need to create the virtual environment (you shold do this), then you can install all dependencies with `pip install -r requirements.txt`
...
### Frezze the requirments

- `pip freeze > requirements.txt`
  - this will create or update your requirments
